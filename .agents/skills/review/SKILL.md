...
4. Thoroughly review what you were asked to review, strictly enforcing all the rules of all the applicable rule books to the review task. You can use sub-agents to split up the work by domain, if it makes sense to do so.
